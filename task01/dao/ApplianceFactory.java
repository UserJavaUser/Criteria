...
public class ApplianceFactory {
	...
	private Appliance createLaptop(String[] applianceData) {
		...
		laptop = new Laptop(Integer.parseInt(applianceData[1]), applianceData[2],
				Integer.parseInt(applianceData[3]), Integer.parseInt(applianceData[4]),
				Double.parseDouble(applianceData[5]), Integer.parseInt(applianceData[6]) );
		return laptop;
	}
	...
	private Appliance createVacuumCleaner(String[] applianceData) {
		...
		vacuumcleaner = new VacuumCleaner(Integer.parseInt(applianceData[1]), applianceData[2],
				applianceData[3], applianceData[4],
				Integer.parseInt(applianceData[5]), Integer.parseInt(applianceData[6]) );
